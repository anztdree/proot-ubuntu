 ...
 *   4. Router/Dispatcher
 *   5. LoginSocket class (mock socket, verifyEnable=false)
 *   6. io.connect() patch
...
(function () {
    ...
    var LoginServerLogger = (function () {
         ...
         * Dipanggil: log.table('CONFIG', { apiBase: '...', loginUrl: '...' })
    ...
    var LoginServer = {
        config: {
            apiBase:       './server/login-server/api.php',
    ...
    // ═══════════════════════════════════════════════════════════════════
    // 5. LOGINSOCKET CLASS (mock socket)
    // ═══════════════════════════════════════════════════════════════════
    //
    // Evidence:
    ...
    LoginSocket.prototype.emit = function (event, data, callback) {
        ...
        if (event === 'handler.process') {
            ...
            setTimeout(function () {
                ...
                // Our mock: receives RAW data (no network, no serialization)
